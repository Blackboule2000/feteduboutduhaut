/*
  # Correction des politiques d'accès public

  1. Modifications
    - Ajout de politiques pour permettre la lecture publique des tables nécessaires
    - Maintien des restrictions d'écriture pour les utilisateurs authentifiés
*/
