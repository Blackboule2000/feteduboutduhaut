/*
  # Insertion des données des concerts

  1. Contenu
    - Ajout des 6 concerts existants avec leurs informations complètes
    - Configuration des scènes pour chaque concert
    - Ajout des URLs des images
*/

INSERT INTO concerts (name, time, description, image_url, stage, order_index)
VALUES
  (
    'MOTOLO',
    '22:00',
