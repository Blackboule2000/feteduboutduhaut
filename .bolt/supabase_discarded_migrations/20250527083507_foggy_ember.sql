...
COMMENT ON TABLE stats IS concat('Table réinitialisée le ', to_char(now(), 'YYYY-MM-DD HH24:MI:SS'));
COMMENT ON TABLE sessions IS concat('Table réinitialisée le ', to_char(now(), 'YYYY-MM-DD HH24:MI:SS'));